...
export type BitflickSiweSignInMutationVariables = Types.Exact<{
  address: Types.Scalars['ID']['input'];
  jwe: Types.Scalars['String']['input'];
}>;


export type BitflickSiweSignInMutation = { __typename?: 'Mutation', siwe: { __typename?: 'SiweResponse', data?: { __typename?: 'SiweData', token: string, user?: { __typename?: 'Web3User', id: string, handle: string, addresses: Array<{ __typename?: 'Address', address: string, type: Types.AddressType }>, roles: Array<{ __typename?: 'Role', id: string, name: string }>, allowedActions: Array<{ __typename?: 'Permission', action: Types.PermissionAction, resource: Types.PermissionResource, identifier?: string | null }> } | null } | null, problems?: Array<{ __typename?: 'AuthProblem', message: string }> | null } };

export type BitflickSiwbSignInMutationVariables = Types.Exact<{
  address: Types.Scalars['ID']['input'];
  jwe: Types.Scalars['String']['input'];
}>;
...
export const BitflickSiweSignInDocument = gql`
  ...
  siwe(address: $address, jwe: $jwe) {
    ...
    `;
export type BitflickSiweSignInMutationFn = Apollo.MutationFunction<BitflickSiweSignInMutation, BitflickSiweSignInMutationVariables>;

/**
 * __useBitflickSiweSignInMutation__
 *
 * To run a mutation, you first call `useBitflickSiweSignInMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useBitflickSiweSignInMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [bitflickSiweSignInMutation, { data, loading, error }] = useBitflickSiweSignInMutation({
 *   variables: {
 *      address: // value for 'address'
 *      jwe: // value for 'jwe'
 *   },
 * });
 */
export function useBitflickSiweSignInMutation(baseOptions?: Apollo.MutationHookOptions<BitflickSiweSignInMutation, BitflickSiweSignInMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<BitflickSiweSignInMutation, BitflickSiweSignInMutationVariables>(BitflickSiweSignInDocument, options);
      }
export type BitflickSiweSignInMutationHookResult = ReturnType<typeof useBitflickSiweSignInMutation>;
export type BitflickSiweSignInMutationResult = Apollo.MutationResult<BitflickSiweSignInMutation>;
export type BitflickSiweSignInMutationOptions = Apollo.BaseMutationOptions<BitflickSiweSignInMutation, BitflickSiweSignInMutationVariables>;
export const BitflickSiwbSignInDocument = gql`
  ...
  siwb(address: $address, jwe: $jwe) {
    ...
    `;
export type BitflickSiwbSignInMutationFn = Apollo.MutationFunction<BitflickSiwbSignInMutation, BitflickSiwbSignInMutationVariables>;

/**
 * __useBitflickSiwbSignInMutation__
 *
 * To run a mutation, you first call `useBitflickSiwbSignInMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useBitflickSiwbSignInMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [bitflickSiwbSignInMutation, { data, loading, error }] = useBitflickSiwbSignInMutation({
 *   variables: {
 *      address: // value for 'address'
 *      jwe: // value for 'jwe'
 *   },
 * });
 */
export function useBitflickSiwbSignInMutation(baseOptions?: Apollo.MutationHookOptions<BitflickSiwbSignInMutation, BitflickSiwbSignInMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<BitflickSiwbSignInMutation, BitflickSiwbSignInMutationVariables>(BitflickSiwbSignInDocument, options);
      }
export type BitflickSiwbSignInMutationHookResult = ReturnType<typeof useBitflickSiwbSignInMutation>;
export type BitflickSiwbSignInMutationResult = Apollo.MutationResult<BitflickSiwbSignInMutation>;
export type BitflickSiwbSignInMutationOptions = Apollo.BaseMutationOptions<BitflickSiwbSignInMutation, BitflickSiwbSignInMutationVariables>;