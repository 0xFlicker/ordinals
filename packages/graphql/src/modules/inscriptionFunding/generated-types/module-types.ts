...
export namespace InscriptionFundingModule {
  interface DefinedFields {
    InscriptionFunding: 'id' | 'fundingAmountBtc' | 'fundingAmountSats' | 'fundingAddress' | 'destinationAddress' | 'network' | 'qrValue' | 'qrSrc' | 'status' | 'fundingGenesisTxId' | 'fundingGenesisTxUrl' | 'fundingRevealTxId' | 'fundingRevealTxUrl' | 'fundingRefundTxId' | 'fundingRefundTxUrl' | 'overhead' | 'padding' | 'count' | 'fee' | 'inscriptionContent' | 'inscriptionContents';
  ...
  export interface MiddlewareMap {
    ...
    InscriptionFunding?: {
      ...
      fundingRefundTxId?: gm.Middleware[];
      fundingRefundTxUrl?: gm.Middleware[];
