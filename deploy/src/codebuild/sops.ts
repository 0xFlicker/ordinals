 ...
 */
export class SopsBuildStack extends Construct {
  ...
  constructor(scope: Construct, id: string, props: CodeBuildStackProps) {
    ...
    this.project = new codebuild.Project(this, "BuildSops", {
      projectName: "build-sops-arm64",
      environment: {
    ...
    new cdk.CfnOutput(this, "SopsBinaryKey", {
      value: this.sopsKey,
      exportName: "CodeBuild-SopsBinaryKey",
    });
  }
}
